    ...
    async def thank(self, ctx, member: discord.Member):
        ...
        if not member.bot:
            if member == ctx.author:
                thank_yourself_embed = discord.Embed(title='\U0001f441  \U0001f441  You tried to thank yourself,'
                                                            'shame on you')
            ...
            await Level.update_experience(Level(self.bot), ctx.guild.id, member.id, random.randint(100, 500))
